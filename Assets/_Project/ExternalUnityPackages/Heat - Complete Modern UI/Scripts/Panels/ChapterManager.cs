...
namespace Michsky.UI.Heat
{
    public class ChapterManager : MonoBehaviour
    {
        ...
        public void InitializeChapters() {
            ...
            foreach (Transform child in chapterParent)
            {
            ...
            for (int i = 0; i < chapters.Count; ++i)
            {
                ...
                if (setPanelAuto == true && item.isCurrent == true)
                {
        ...
        public void NextChapter() {
            if (currentChapterIndex + 1 > identifiers.Count - 1 || showLockedChapters == false &&
                identifiers[currentChapterIndex + 1].isLocked == true)
                return;
        ...
        public void PrevChapter() {
            if (currentChapterIndex <= 0 ||
                showLockedChapters == false && identifiers[currentChapterIndex - 1].isLocked == true)
                return;
